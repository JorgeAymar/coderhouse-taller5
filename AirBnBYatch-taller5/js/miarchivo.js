...
listaProductos.push(new Product("Niza", "Portugal", 50, "Yate para vacaciones en Mediterraneo, zarpa de Isla en Portugal"))
listaProductos.push(new Product("My Princess", "Miami", 75, "Yate para vacaciones en caribe, zarpa de Miami"))
